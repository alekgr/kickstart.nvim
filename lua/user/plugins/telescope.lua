return { -- Fuzzy Finder (files, lsp, etc)
  ...
  opts = function()
    ...
    vim.keymap.set('n', '<leader>fg', builtin.live_grep, { desc = 'telescope [S]earch by [G]rep' })
    vim.keymap.set('n', '<leader>fd', builtin.diagnostics, { desc = 'telescope [S]earch [D]iagnostics' })
    vim.keymap.set('n', '<leader>fr', builtin.resume, { desc = 'telescope[S]earch [R]esume' })
    vim.keymap.set('n', '<leader>f.', builtin.oldfiles, { desc = 'telescope [S]earch Recent Files ("." for repeat)' })
    vim.keymap.set('n', '<leader><leader>', builtin.buffers, { desc = 'teelescope [ ] Find existing buffers' })
